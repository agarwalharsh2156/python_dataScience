...
# .groupby() groups the data based on a particular series and provides the statistical interpretation with respect to it
# used to find relation between two series or trend in one series with respect to other
print(df.groupby("Age")["Gender"].describe())
# In the above code we are looking for trend in Female with respect to Age. Also here the interpretation is not too informative,
